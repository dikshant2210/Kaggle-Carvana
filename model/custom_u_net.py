...
from keras.layers import Input, concatenate, Conv2D, BatchNormalization, Activation, UpSampling2D, MaxPooling2D
from keras.optimizers import RMSprop
from model.losses import dice_loss, bce_dice_loss


def custom_unet_256(input_shape=(256, 256, 3),
                 num_classes=1):
